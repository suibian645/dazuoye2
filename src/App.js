...
//  合约地址
const UNIVERSAL_POINTS_ADDRESS = "0xe344Eb4356caf5cfE284C1963895644c04a1177E";
const POINTS_EXCHANGE_ADDRESS  = "0x47F6cC9C92609E0F12Eb4e16D246accC20eF812C";
  ...
  return (
    <div className="App">
      ...
      {!isWalletConnected ? (
        ...
        <div>
          {account && <p className="info-text">连接账号: {account}</p>}
          ...
          <div className="card">
            ...
            />
            <button className="btn" onClick={handleLoadContract}>
              导入合约
            </button>
          </div>
          ...
          <div className="card">
            ...
            <input
              ...
              placeholder="amount"
            />
            <button className="btn" onClick={issueRegularPoints}>
              发行积分
            </button>
          </div>
          ...
          <div className="card">
            ...
            <button className="btn" onClick={getPointsBalance}>
              更新余额
            </button>
          </div>
          ...
          <div className="card">
            ...
            <button className="btn" onClick={exchangePoints}>
              兑换
            </button>
          </div>
        </div>
